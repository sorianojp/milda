...
<a class="btn btn-dark download-link intro-download" href="{{ route('course-materials.syllabus') }}" download><svg><use href="#i-file"></use></svg>Download MILDA Course Syllabus</a>
...
<main class="main">
<header class="topbar">
<div class="top-left"><button aria-controls="sidebar" aria-expanded="false" aria-label="Open navigation" class="mobile-menu" id="mobileMenu"><svg><use href="#i-menu"></use></svg></button><div class="page-title"><h2 id="pageHeading">Student Dashboard</h2><p id="pageSubheading">Your learning and verification progress</p></div></div>
...
<button aria-label="Close navigation" class="sidebar-backdrop" id="sidebarBackdrop" type="button"></button>
</div>
